...
$(".checkout-button").click(function () {
  ...
  const getQuantityStrawberriesCream = $(
    ".quantity-scoops-strawberries-cream"
  ).val();

  // calculate the total cost of the order //
  let total =
    coconut_mango_price * getQuantityCoconutMango +
    salted_caramel_price * getQuantitySaltedCaramel +
    strawberries_cream_price * getQuantityStrawberriesCream;
